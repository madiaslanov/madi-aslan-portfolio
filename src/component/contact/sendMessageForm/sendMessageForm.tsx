        ...
        <div>
            <form className={style.formHolder} onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className={style.inputMin1}>
                    <img className={style.left} src="/rectan/min-lf.svg" alt=""/>
                    <img className={style.right} src="/rectan/min-bt.svg" alt=""/>
                ...
                <div className={style.inputBig1}>
                    <img className={style.left} src="/rectan/big-lf.svg" alt=""/>
                    <img className={style.right} src="/rectan/big-bt.svg" alt=""/>
